...
// ZIP extraction requires minizip (unzip.h), which is not included in UE 5.1.
// MESHY_MINIZIP_SUPPORTED is set to 0 in Build.cs; ExtractZipFile will log an error.
